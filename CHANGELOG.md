22/7/25:
- seq.values now lets you type lists of values in directly. you need to bring up the big edit page for the seq.values block and have your mouse over the lane you want to type into, then separate values by commas. eg c4,c#4,36,37,,,,2,3,127 [enter].
