...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 649.0, 606.0, 154.0, 22.0 ],
					"text" : "240 0 32 41 2 17 119 0 247"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 820.0, 542.0, 179.0, 22.0 ],
					"text" : "prepend 240 0 32 41 2 17 120 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 813.0, 606.0, 47.0, 22.0 ],
					"text" : "midiout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 1266.5, 384.0, 66.0, 22.0 ],
					"text" : "listfunnel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1269.0, 311.0, 85.0, 22.0 ],
					"text" : "vexpr $i1 * $i2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1232.0, 265.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1269.0, 163.0, 29.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1269.0, 265.0, 51.0, 22.0 ],
					"text" : "zl group"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1280.0, 195.0, 61.0, 22.0 ],
					"text" : "zl group 3"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 51.0, 137.0, 29.5, 22.0 ],
									"text" : "+"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 48.0, 235.0, 29.5, 22.0 ],
									"text" : "| 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 85.0, 235.0, 33.0, 22.0 ],
									"text" : "<< 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 85.0, 203.0, 33.0, 22.0 ],
									"text" : ">> 6"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 48.0, 203.0, 33.0, 22.0 ],
									"text" : ">> 6"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 51.0, 70.0, 77.0, 22.0 ],
									"text" : "unpack 0 0 0"
								}
...
,
					"patching_rect" : [ 1280.0, 231.0, 180.0, 22.0 ],
					"text" : "p RGBtoLaunchControlXLcolour"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 502.0, 57.0, 22.0 ],
					"text" : "pack 0 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 215.0, 315.0, 144.0, 22.0 ],
					"saved_object_attributes" : 					{
						"legacy" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 208.0, 433.0, 71.0, 22.0 ],
					"text" : "unpack 0 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 395.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 208.0, 357.0, 29.5, 22.0 ],
					"text" : "=="
				}
...
,
					"patching_rect" : [ 890.0, 352.0, 91.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1326.0, 347.0, 54.0, 22.0 ],
					"text" : "offset $1"
				}
